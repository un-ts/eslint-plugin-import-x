...
Rewrite the module analysis core for performance boosts.
...
No configuration changes are needed. The speedup depends on your project, and we expect no performance regression in any setup — if you measure one, please report it.
