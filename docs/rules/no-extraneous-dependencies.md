...
```js
"import-x/no-extraneous-dependencies": ["error", {"devDependencies": false, "optionalDependencies": false, "peerDependencies": false}]
```
...
/* eslint import-x/no-extraneous-dependencies: ["error", {"bundledDependencies": false}] */
