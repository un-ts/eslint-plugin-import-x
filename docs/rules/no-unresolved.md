...
```js
/*eslint import-x/no-unresolved: [2, { commonjs: true }]*/
...
```js
/*eslint import-x/no-unresolved: [2, { amd: true }]*/
...
```js
/*eslint import-x/no-unresolved: [2, { commonjs: true, amd: true }]*/
const { default: x } = require('./foo') // reported if './foo' is not found
define(['./foo'], function (foo) {
  /*...*/
}) // reported if './foo' is not found
...
```js
/*eslint import-x/no-unresolved: [2, { caseSensitive: true (default) | false }]*/
...
```js
/*eslint import-x/no-unresolved: [2, { caseSensitiveStrict: true }]*/
...
- [`import-x/ignore`] global setting
