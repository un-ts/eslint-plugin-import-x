...
// configs
import type { PluginConfig, PluginFlatBaseConfig, PluginFlatConfig } from './types'
...
const createFlatConfig = (baseConfig: PluginFlatBaseConfig, configName: string): PluginFlatConfig => ({
  ...baseConfig,
