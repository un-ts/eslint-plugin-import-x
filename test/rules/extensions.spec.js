...
import rule from 'eslint-plugin-i/rules/extensions'
...
ruleTester.run('extensions', rule, {
  valid: [
    ...
    test({
      ...
      options: ['never'],
      settings: { 'i/resolver': { extensions: ['.js', '.jsx', '.json'] } },
    }),
    ...
    test({
      ...
      settings: {
        'i/resolver': { extensions: ['.js', '.jsx', '.json', '.hbs'] },
      },
    }),
    ...
    test({
      ...
      settings: { 'i/resolver': { extensions: ['.js', '.json'] } },
    }),
  ...
  invalid: [
    ...
    test({
      ...
      options: [{ json: 'always', js: 'never', jsx: 'never' }],
      settings: { 'i/resolver': { extensions: ['.jsx', '.json', '.js'] } },
      errors: [
        {
    ...
    test({
      ...
      settings: { 'i/resolver': { extensions: ['.coffee', '.js'] } },
    }),
