...
import rule from 'eslint-plugin-i/rules/no-unresolved'
...
ruleTester.run('no-unresolved (i/resolve legacy)', rule, {
  valid: [
    test({
      ...
      settings: {
        'i/resolver': {
          paths: [path.resolve('test/fixtures/alternate-root')],
        },
      },
    }),
    ...
    test({
      ...
      settings: {
        'i/resolver': {
          paths: [
            path.resolve('test/fixtures/src-root'),
            path.resolve('test/fixtures/alternate-root'),
          ],
        },
      },
    }),
    ...
    test({
      ...
      settings: { 'i/resolver': { extensions: ['.jsx'] } },
    }),
  ],
