...
import rule from 'eslint-plugin-i/rules/named'
...
ruleTester.run('named', rule, {
  valid: [
    ...
    test({
      ...
      settings: { 'i/resolver': { extensions: ['.js', '.jsx'] } },
    }),
  ...
  invalid: [].concat(
    ...
    //   settings: { 'i/extensions': ['.js', '.coffee'] },
    //   errors: [{
