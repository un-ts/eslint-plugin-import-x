...
;(isESLint10 ? describe.skip : describe)('no-unused-modules', () => {
  ...
  describe('dynamic imports', () => {
      ...
      valid: [
        tValid({
          ...
          filename: testFilePath(
            './no-unused-modules/exports-for-dynamic-js.js',
          ),
        }),
      ],
      invalid: [
    ...
    typescriptRuleTester.run('no-unused-modules', rule, {
      ...
      `,
          filename: testFilePath(
            './unused-modules-reexport-crash/src/index.tsx',
          ),
  ...
  describe('test behavior for new file', () => {
    beforeAll(() => {
      fs.writeFileSync(
        testFilePath('./no-unused-modules/file-added-0.js'),
        '',
        {
          encoding: 'utf8',
          flag: 'w',
    ...
    describe('test behavior for new file', () => {
      ...
      afterAll(() => {
        if (
          fs.existsSync(testFilePath('./no-unused-modules/file-added-1.js'))
        ) {
  ...
  describe('test behavior for new file', () => {
    beforeAll(() => {
      fs.writeFileSync(
        testFilePath('./no-unused-modules/file-added-2.js'),
        '',
        {
          encoding: 'utf8',
          flag: 'w',
  ...
  describe('test behavior for new file', () => {
    beforeAll(() => {
      fs.writeFileSync(
        testFilePath('./no-unused-modules/file-added-3.js'),
        '',
        {
          encoding: 'utf8',
          flag: 'w',
  ...
  describe('test behavior for new file', () => {
    ...
    afterAll(() => {
      if (
        fs.existsSync(testFilePath('./no-unused-modules/file-added-4.js.js'))
      ) {
    ...
    ruleTester.run('no-unused-modules', rule, {
      valid: [
        ...
        tValid({
          code: `#!/usr/bin/env node\nimport {foo} from './prefix-child.js';\n`,
          filename: testFilePath(
            './no-unused-modules/prefix-parent-hashbang.js',
          ),
          options: unusedExportsOptions,
        }),
      ],
  ...
  for (const [name, FlatRuleTester] of [
    ...
    ;(isESLint10 ? describe.skip : describe)('supports ' + name, () => {
