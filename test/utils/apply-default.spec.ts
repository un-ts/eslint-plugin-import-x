...
describe(applyDefault, () => {
  ...
  it('returns applies a deepMerge to each element in the array', () => {
    const defaults: Array<Record<string, string>> = [
      {
        other: 'other',
        prop: 'setting1',
      },
    ...
    const user: Array<Record<string, string>> = [
      {
        other: 'something',
        prop: 'new',
      },
